  ...
  <body>
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        <li class="active"><a href="home.php">All movies <span class="sr-only">(current)</span></a></li>
	...
	<div class="row">
		...
		<?php
			...
			$statement = "SELECT title, run_time, Cover_img FROM Movie";
			...
			while($row=$result->fetch_array(MYSQLI_ASSOC)){
				...
				echo "<div class=\"card\" style=\"width:18rem;\">";
					...
					echo "<p class=\"card-text\">Run Time: ". $row["run_time"] . "</p>";
					?>
					<form action="movieInfo.php" method = "post">
					<!--echo "<a href = \"#\" class=\"btn btn-primary\">See movie details</a>";-->
						<input type= "hidden" name="movie_title" value="<?php echo $row["title"];?>">
						<input type="submit" name = "submit" value="See movie details" class ="btn btn-primary">
