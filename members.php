      ...
      if(isset($_POST['submit-search'])){
        ...
        if(!empty($_POST['account'])){
           ...
           <div class="box1234">
            ...
            <span class="box-details1234 name"><?php echo $firstname; ?></span>
            <span class="box-details1234 name"><?php echo $lastname; ?></span>
            <span class="box-details1234 email"><?php echo $email; ?></span>
            <span class="box-details1234 account"><?php echo $_POST['account']; ?></span>
          ...
          while($stmt->fetch()){ ?>
            ...
            <span class="box-details1234 name"><?php echo $_POST['firstname']; ?></span>
            <span class="box-details1234 name"><?php echo $_POST['lastname']; ?></span>
            <span class="box-details1234 email"><?php echo $email; ?></span>
            <span class="box-details1234 account"><?php echo $account_number; ?></span>
