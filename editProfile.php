      ...
      ?>	
				<form method="post" action="">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="card-number" id="card-number" value="<?php echo $ccard; ?>" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" name="card-expiry" id="card-number" value="<?php echo $card_expiry; ?>" required>
